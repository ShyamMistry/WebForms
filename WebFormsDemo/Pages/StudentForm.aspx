...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <h1>Web Forms In Class 03 By Shyam Mistry</h1>
    </div>
     <div class="row">
        <div class="col-md-12 alert alert-info">
            This is In Class 03 basic web form construction, data collection with validation, and display, but no database.
        </div>
    </div>
<div class="row">
